            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'Shahzaib-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Shahzaib  GitHub Repo](https://github.com/kingmalvn/)  

🚀 _Thanks for choosing Shahzaib-Md— Let the automation begin!_ ✨`;
